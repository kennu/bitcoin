...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Falckoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and falckoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Falckoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Falckoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a falckoin: URI or payment request"));
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("Falckoin client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Falckoin client") + " " + tr("[testnet]"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Falckoin network", "", count));
}
...
{
    QString strTitle = tr("Falckoin"); // default title
